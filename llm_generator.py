...
OUT_EMB = f"{out_path}{args.pretrain_model}/"
OUT_EMB_1 = f"{OUT_EMB}embeddings-agent1{args.embedding_type}.npy"
OUT_EMB_2 = f"{OUT_EMB}embeddings-agent2{args.embedding_type}.npy"
